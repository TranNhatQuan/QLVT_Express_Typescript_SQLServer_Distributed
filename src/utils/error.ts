...
export const Errors = {
  ...
  InvalidFileType: new ErrorResp("error.invalidFileType", "Invalid file type."),
  ...
  AccountNotFound: new ErrorResp("error.AccountNotFound", "Account not found"),
  ...
  SettingNotFound: new ErrorResp("error.SettingNotFound", "Setting not found"),
  SettingExisted: new ErrorResp("error.SettingExisted", "Setting existed"),
  InvalidPostCode: new ErrorResp("error.InvalidPostCode", "Post code invalid"),
...
export const handleError = (err: Error, res: Response) => {
  if (err instanceof ErrorResp) {
    ...
    if (config.isProduction()) {
      res
        .status(Errors.Sensitive.status)
        .json(new ResponseWrapper(null, Errors.Sensitive));
      return;
    }
    ...
    res
      .status(Errors.Sensitive.status)
      .json(new ResponseWrapper(null, errResp));
  }
};
